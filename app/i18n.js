...
(function () {
  ...
  var DICT = {
    en: {
      ...
      "disclaimer.text": "<strong>Reference only.</strong> Data and decoded results may contain errors. Always cross-check against manufacturer datasheets and apply engineering judgment before specifying or installing any connector.",
      "disclaimer.lead": "Reference only.",
      "disclaimer.body": "Data and decoded results may contain errors. Always cross-check against manufacturer datasheets and apply engineering judgment before specifying or installing any connector.",
    ...
    he: {
      ...
      "disclaimer.text": "<strong>לעיון בלבד.</strong> הנתונים ותוצאות הפענוח עלולים להכיל טעויות. יש לבדוק תמיד מול גיליון הנתונים של היצרן ולהפעיל שיקול דעת הנדסי לפני אפיון או התקנה של מחבר.",
      "disclaimer.lead": "לעיון בלבד.",
      "disclaimer.body": "הנתונים ותוצאות הפענוח עלולים להכיל טעויות. יש לבדוק תמיד מול גיליון הנתונים של היצרן ולהפעיל שיקול דעת הנדסי לפני אפיון או התקנה של מחבר.",
